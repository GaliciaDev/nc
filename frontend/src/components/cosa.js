                ...
                <div class="swiper-wrapper w-max">
                    <div class="swiper-slide">
                        <div
                            ...
                            <div class="flex items-center gap-5 border-t border-solid border-gray-200 pt-5">
                                <img class="rounded-full h-10 w-10" src="https://pagedone.io/asset/uploads/1696229969.png"
                                    alt="avatar" />
                                <div class="block">
                    ...
                    <div class="swiper-slide">
                        <div
                            ...
                            <div class="flex items-center gap-5 pt-5 border-t border-solid border-gray-200">
                                <img class="rounded-full h-10 w-10" src="https://pagedone.io/asset/uploads/1696229994.png"
                                    alt="avatar" />
                                <div class="block">
                    ...
                    <div class="swiper-slide">
                        <div
                            ...
                            <div class="flex items-center gap-5 border-t border-solid border-gray-200 pt-5">
                                <img class="rounded-full h-10 w-10" src="	https://pagedone.io/asset/uploads/1696230027.png"
                                    alt="avatar" />
                                <div class="block">
